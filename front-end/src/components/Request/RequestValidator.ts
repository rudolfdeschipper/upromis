/*
** Implementation of client side Validation  () for Request
...
{
    static Validate = async (values: IRequestData) : Promise<FormikErrors<IRequestData>> => {
        var errors: FormikErrors<IRequestData> = {};
